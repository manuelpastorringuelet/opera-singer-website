const Datenschutzerklärung = () => {
  return (
    <>
      ...
      <h2 className="text-xl font-semibold">Weitergabe von Daten</h2>
      ...
      <h2 className="text-xl font-semibold">Widerspruchsrecht</h2>

      <section className="flex flex-col gap-1">
        <p>
          Sofern Ihre personenbezogenen Daten auf Grundlage von berechtigten
          Interessen gemäß Art. 6 Abs. 1 S. 1 lit. f DSGVO verarbeitet werden,
          haben Sie das Recht, Widerspruch gegen die Verarbeitung Ihrer
      ...
      <p>
        ...
        <a href="mailto:taryn.knerr@example.com">
          martin.taryn.knerr@example.com
        </a>
        .
      </p>
      ...
      <section className="flex flex-col gap-1">
        ...
        <p>
          ...
          unter{" "}
          <a
            href="https://www.tarynknerr.com/impressum"
            target="_blank"
            rel="noopener noreferrer"
          >
            www.tarynknerr.com/impressum
          </a>{" "}
